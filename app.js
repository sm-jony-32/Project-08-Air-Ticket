...
document.querySelector('.book-now').addEventListener('click', function () {
    const travelerName = document.querySelector('.traveler-name').value;
    const travelerAge = document.querySelector('.traveler-age').value;
    ...
    if (!travelerName || !travelerAge || !fryingFrom || !fryingTo || !fryingDeparture || !fryingReturn || !firstClassTicket || !economyTicket) {
        ...
        document.querySelector('.user-traveler-name').textContent = travelerName;
        document.querySelector('.user-traveler-age').textContent = travelerAge;
